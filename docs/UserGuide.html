...
<body>
    ...
    either extracted from the Java JAR file (at most once per run of
    Run-REDUCE-FX to your default temporary directory) or assumed to
    be available in the REDUCE installation.  The Help menu provides
